...
public class AddRestaurantProductsActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = AddRestaurantProductsActivity.class.getSimpleName();
    Toolbar mToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customToolbar("Add Restaurant Product");
        ...
        vegRB.setOnClickListener(this);
        nonvegRB.setOnClickListener(this);

        final String serviceNameList[] = {"Select Menu","Main Course","Starter","Appetizers","Combos","Sides","Drinks","Breads","Rice","Desert"};
        ...
        serviceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0) {
                    ...
                    Toast.makeText(AddRestaurantProductsActivity.this, serviceSpinnerList.get(position) + " selected", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.vegRB:
                vegRB.setChecked(true);
                nonvegRB.setChecked(false);
                break;

            case R.id.nonvegRB:
                nonvegRB.setChecked(true);
                vegRB.setChecked(false);
                break;
