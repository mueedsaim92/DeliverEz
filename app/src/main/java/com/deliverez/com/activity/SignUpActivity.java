...
import com.deliverez.com.imagePicker.imageActivity.GalleryImageActivity;
...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener, CategorysAdapter.ActionListener {
    ...
    private final String listNames[] = {"Electronics","Grocery",  "Vegetables", "Fruits","Dairy","Sweets","Restaurant"};
    private Integer imgs[]={R.drawable.electronics,R.drawable.grocery,R.drawable.vegetables,R.drawable.fruits,
            R.drawable.dairy,R.drawable.sweet,R.drawable.restaurant};
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.saveBT:
                ...
                otp.putExtra("MOBILE","0000000000");
                startActivity(otp);
                //startPayment();
    ...
    private void gotoGallery() {
        ...
        if (result == PackageManager.PERMISSION_GRANTED && result2 == PackageManager.PERMISSION_GRANTED && result1 == PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(SignUpActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 2000);
        }
    ...
    private void getCategory() {
        ...
        header.put("authorization", DeliverezConstants.getDeviceId());
        ...
        if (Methods.isInternetConnected(getApplicationContext(), true)) {
            ...
            Call<CategoryResponse> call = apiService.getCategory(header);
            call.enqueue(new retrofit2.Callback<CategoryResponse>() {
                ...
                public void onResponse(Call<CategoryResponse> call, Response<CategoryResponse> response) {
                    ...
                    Log.d("RESPONSE >>> ", "" + categoryResponse);
